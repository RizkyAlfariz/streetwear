...
import HeaderStreetwear from "@/components/HeaderStreetwear.vue";
import FooterStreetwear from "@/components/FooterStreetwear.vue";
import carousel from 'vue-owl-carousel';
import RelatedStreetwear from '@/components/RelatedStreetwear.vue';
...
export default {
  ...
  data() {
    return {
      gambar_default: "img/Stone-Island/Si-1.jpg",
      thumbs: [
        "img/Stone-Island/Si-1.jpg",
        "img/Stone-Island/Si-2.jpg",
        "img/Stone-Island/Si-3.jpg",
        "img/Stone-Island/Si-1.jpg"
      ]
    }
  },
